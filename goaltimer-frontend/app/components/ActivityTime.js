...
function ActivityTime({activityName, activityDuration, activitySchedule, onPress, color}) {
        ...
        <View style={{width: '95%', alignSelf: 'center'}}>
            <View style={{
                ...
                <TouchableOpacity style={styles.showButtonContainer} onPress={onPress}>
                    <Image style={styles.chevronRight} source={require('../assets/images/clock.png')} />
                </TouchableOpacity>
            </View>
        </View>
    );
