...
public class UserController {
  ...
  // public int updateEmployee(@RequestBody User user, @PathVariable String email,
  ...
  // public String addEmployee(@RequestBody User user, @PathVariable String
  // firstName, @PathVariable String lastName, @PathVariable String email,
  ...
  // //is email is not the same as the user's email in the session- redirect them
  // back to login
